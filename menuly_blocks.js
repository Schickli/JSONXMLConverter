...
Blockly.Blocks["start"] = {
  init: function () {
    ...
    this.appendValueInput("json").appendSelector(
      ["dictionary", "array", "string", "number", "true", "false", "node"],
...
Blockly.Blocks["true"] = {
  init: function () {
    ...
    this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField("true");
  },
};
...
Blockly.Blocks["false"] = {
  init: function () {
    ...
    this.appendDummyInput().setAlign(Blockly.ALIGN_CENTRE).appendField("false");
  },
};
